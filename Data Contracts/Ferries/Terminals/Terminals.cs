...
namespace WsdotTravelerInfoContracts.Ferries.Terminals
{
	...
	/// <summary>
	/// Represents a wait time for a route.
	/// </summary>
	...
	public class Terminal
	{
		...
		/// <summary>Where this terminal should appear on a GIS map (at various zoom levels).</summary>
		...
		/// <summary>Link to the chamber of commerce associated with this terminal.</summary>
